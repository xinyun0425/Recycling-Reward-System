...
<body>
    ...
    <?php
        ...
        if(mysqli_connect_errno()){
            ...
            WHERE dropoff.status = 'Complete' OR dropoff.status='Expired'";
    ...
    <div class="content">
        ...
        <div class="upperbutton">
            <button class="today" onclick="window.location.href='Admin-Dropoff.php'">Drop-off Requests</button>
            <button class="all active" >Completed Requests</button>
        </div>  
        <div class="detail-card">
            ...
            <table id="assigned_table">
                ...
                ?>
                <tr class="row_hover" onclick="window.location.href='Admin-Dropoff-Complete-Detail.php?dropoff_id=<?php echo $row['dropoff_id'];?>'">
                ...
                ?>
                    <tr id="no-records-row">
                        <td colspan="6" style="text-align:center; padding: 20px; background-color:white;">
                            ...
                            No Completed Drop-off Request Found.</span>
                        </td>
                    </tr>
                <?php
                }
