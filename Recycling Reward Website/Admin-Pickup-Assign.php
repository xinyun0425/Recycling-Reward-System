...
<body>
    ...
    <div class="content">
        ...
        <div class="upperbutton">
            ...
            <button class="assign active">Assigned Requests</button>
        ...
        <div class="detail-card">
            ...
            <?php
                ...
                $sql="SELECT pickup_request.pickup_request_id, user.username, driver.driver_name, time_slot.date AS pickup_date, time_slot.time AS pickup_time, pickup_request.status,
                ...
                WHERE pickup_request.status = 'assigned'
            ...
            <table id="assigned_table">
                ...
                ?>
                <tr class="row_hover" onclick="window.location.href='Admin-Pickup-Assign-Detail.php?pickup_request_id=<?php echo $row['pickup_request_id'];?>'">
                    ...
                    <td style="text-align:left;padding-left:0;">
                        <span class="status-badge status-assigned"><?php echo ucfirst($row['status']); ?></span>
                    </td>
                <tr>               
                <?php
                    }
                ...
                ?>
                    <tr id="no-records-row">
                        <td colspan="6" style="text-align:center; padding: 20px; background-color:white;">
                            ...
                            No Assigned Pickup Request Found.</span>
                        </td>
                    </tr>
                    <?php
                    }
    ...
    <script>
        ...
        function filterByDate() {
            ...
            for (let i = 1; i < rows.length; i++) { 
                ...
                const showRow = !pickupDate || formattedRowPickupDate === pickupDate;
